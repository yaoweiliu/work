...
static int __init ssd1307fb_demo_init(void)
{
	printk("%s\n", __func__);
	return i2c_add_driver(&ssd1307fb_driver);
}

static void __exit ssd1307fb_demo_exit(void)
{
	i2c_del_driver(&ssd1307fb_driver);
}

module_init(ssd1307fb_demo_init);
module_exit(ssd1307fb_demo_exit);
