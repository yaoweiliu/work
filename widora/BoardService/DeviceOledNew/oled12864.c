...
//static struct i2c_board_info __initdata i2c_devs1 = { I2C_BOARD_INFO("OLED12864", (0x3c))};
...
//1.
static const struct of_device_id oled_dts_id[] = {
	{.compatible = "OLED12864",},
	{ },
};

MODULE_DEVICE_TABLE(of, oled_dts_id);

static struct i2c_driver oled_driver = {
	.driver		= {
		.name	= DEVICE_NAME,
		.owner	= THIS_MODULE,
		.of_match_table = of_match_ptr(oled_dts_id),
	},
	.probe		= oled_probe,
	.remove		= oled_remove,
	.id_table	= oled_id,
